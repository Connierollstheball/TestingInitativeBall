...
new MaterialProperty(jojoMaterial) {
   friction = 100;
   restitution = 100;
};
...
new MaterialProperty(BounceMaterial) {
friction = 1;
restitution = 1;
force = 15;
};

new MaterialProperty(Bounce2Material) {
friction = 1;
restitution = 1;
force = 20;
};
...
addMaterialMapping( "pattern_neutral5" ,   jojoMaterial);
...
addMaterialMapping( "Bounce2" , Bounce2Material);
addMaterialMapping( "Bounce1" , BounceMaterial);
addMaterialMapping( "custom_sand" , SandMaterial);
