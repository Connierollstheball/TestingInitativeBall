...
datablock ItemData(ShockAbsorberItem)
{
   ...
   // Dynamic properties defined by the scripts
   pickupName = "Alex's Special Shock Absorber!";
...
datablock ItemData(HelicopterItem)
{
   ...
   // Dynamic properties defined by the scripts
   pickupName = "a Temporary Flying Machine!";
...
datablock AudioProfile(doMarkSfx)
{
   filename    = "~/data/sound/doHelicopter.wav";
   description = AudioDefault3d;
   preload = true;
...
datablock AudioProfile(PuMarkSfx)
{
   filename    = "~/data/sound/puMark.wav";
   description = AudioDefault3d;
   preload = true;
};

datablock ItemData(Mark1Item)
{
   // Mission editor category
   category = "Powerups";
   className = "PowerUp";
   ...
   activeAudio = DoMarkSfx;
   pickupAudio = PuMarkSfx;

   // Basic Item properties
   shapeFile = "~/data/shapes/images/TutorialMark.dts";
   mass = 1;
   friction = 1;
   elasticity = 0.3;

   // Dynamic properties defined by the scripts
   pickupName = "a Mystery Mark!!";
   useName = "Mystery Mark PowerUp";
   maxInventory = 1;
};
...
datablock AudioProfile(PuEasterEggSfx)
{
   filename    = "~/data/sound/EasterEgg.wav";  
   description = AudioDefault3d;
   preload = true;
};

datablock ItemData(SecondEasterEgg) {
   // Mission editor category
   category = "Secrets";
   className = "PowerUp";

   pickupAudio = PuEasterEggSfx; 
...
datablock ItemData(OmegaEasterEgg) {
   // Mission editor category
   category = "Secrets";
   className = "PowerUp";
   ...
   // Dynamic properties defined by the scripts
   pickupName = "a Omega Easter Egg!!";
   useName = "Omega Easter Egg";
   maxInventory = 1;   
};
...
datablock AudioProfile(PuTokenSfx)
{
   filename    = "~/data/sound/Token.wav";  
   description = AudioDefault3d;
   preload = true;
};

datablock ItemData(Token) {
   // Mission editor category
   category = "Secrets";
   className = "PowerUp";

   pickupAudio = PuTokenSfx; 

   // Basic Item properties
   shapeFile = "~/data/shapes/items/Token.dts";  
   mass = 1;
   friction = 1;
   elasticity = 0.3;
   emap = false;
   ...
   // Dynamic properties defined by the scripts
   pickupName = "a Secret Token!!";
   useName = "Secret Token";
   maxInventory = 1;   
};
...
datablock ItemData(RuntimeErrorItem)
{
   // Mission editor category
   category = "Secrets";
   className = "PowerUp";
   ...
   // Basic Item properties
   shapeFile = "~/data/shapes/items/TutorialMark.dts";  
   mass = 1;
   friction = 1;
   elasticity = 0.3;

   // Dynamic properties defined by the scripts
   pickupName = "a Runtime Error Crashing!!";
   useName = "Runtime Error Crashing";
   maxInventory = 1;
};

function RuntimeErrorItem::onUse(%this,%marble) {
   localclientconnection.player.setCloaked(true);
   schedule(5000, 0, "undoIMI");
}
...
datablock AudioProfile(PuGemSfx)
{
   filename    = "~/data/sound/SecretGemPickup.wav";  
   description = AudioDefault3d;
   preload = true;
};

datablock ItemData(SecretGem) {
   // Mission editor category
   category = "Secrets";
   className = "PowerUp";

   pickupAudio = PuGemSfx; 

   // Basic Item properties
   shapeFile = "~/data/shapes/items/gemmbg.dts";  
   mass = 1;
   friction = 1;
   elasticity = 0.3;
   emap = false;
   ...
   // Dynamic properties defined by the scripts
   pickupName = "a usseles gem! some more to go!";
   useName = "MbgGem";
   maxInventory = 1;   
};
...
datablock AudioProfile(PuDildoSuperJumpVoiceSfx)
{
   filename    = "~/data/sound/puSuperJumpVoice.wav";
   description = AudioDefault3d;
   preload = true;
...
datablock ItemData(DildoSuperJumpItem)
{
   // Mission editor category
   category = "Secrets";
   className = "PowerUp";
   ...
   pickupAudio = PuDildoSuperJumpVoiceSfx;
   ...
   // Dynamic properties defined by the scripts
   pickupName = "a Suspiciously Sticky Super Jump!";
   useName = "Suspiciously Sticky Super Jump";
   maxInventory = 1;
};

function DildoSuperJump::onUse(%this,%marble) {
   localclientconnection.player.setCloaked(true);
   schedule(5000, 0, "undoIMI");
}
